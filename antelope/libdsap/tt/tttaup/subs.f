      subroutine cortt (dtdd, h, v, ttcor)
c
      real*4            dtdd
      real*4                  h
      real*4                     v
      real*4                        ttcor
c
c    Subroutine cortt will compute a travel time correction for 
c    station elevation.
c
c    Inputs -	dtdd	= The derivative of travel time with respect
c			  to distance for the ray in units of seconds per
c			  degree.
c		h	= The station elevation in km.
c		v	= The local velocity in km/sec.
c
c    Output -	ttcor	= The travel time correction relative to a sea
c			  level station in seconds.
c
      real*8 pi
...
c
      ...
      tmpnam = modnam(1:nb)//'.tbl'
      call dasign(nin,-1,tmpnam,nasgr)
c
      do 11 nph=1,2
...
c $Id: subs.f,v 1.1.1.1 1997/04/12 04:18:47 danq Exp $ 
