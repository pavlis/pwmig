...
This interface is identical to the one under namespace SEISPP, but
the implementation is made to remove antelope dependencies on 
Tbl and Arr structs that have proven problematic in these modifications.
